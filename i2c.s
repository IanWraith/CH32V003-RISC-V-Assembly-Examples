...
#
# /opt/riscv/riscv32-unknown-linux-gnu/bin/as -march=rv32ec -mabi=ilp32e i2c.s -o i2c.o
# /opt/riscv/riscv32-unknown-linux-gnu/bin/objdump -S i2c.o > i2c.lst
# /opt/riscv/riscv32-unknown-linux-gnu/bin/objcopy -O binary i2c.o i2c.bin
# /opt/riscv/riscv32-unknown-linux-gnu/bin/objcopy -O ihex i2c.o i2c.hex
#
# Then sent to the dev board with ..
#
# minichlink -w i2c.bin flash -b
...
lw a4,24(t1)
# Enable IOPCEN , IOPDEN and AFIOEN which is BIT04 + BIT05 + BIT00 = 49
ori t2,t2,49
or a4,a4,t2
...
and	a4,a4,-16
# This makes MODE0 01 and CNF0 00 so Output mode max speed 10 MHz in universal push-pull mode.  
ori a4,a4,BIT00
# Write the changed value back to GPIOD_CFGLR
sw	a4,1024(t1)
# Port C configuration CNF1 and CNF2 to 11 (multiplexed open drain) MODE1 and MODE2 to 01 10 MHz 
# So 11101110 (238) 2 MHz , 11011101 (221) 10 MHz , 11111111 (255) 50 MHz
# Open Drain not multiplexed 50 MHz 01110111 (119)
lw a4,0(t1)
# AND to clear the bits
and	a4,a4,-15
